...
import img1 from "../../assets/grammar2.png";
import GrammarChecker from "../../Components/GrammarChecker/GrammarChecker";
    ...
    <div className="dark:bg-slate-800 bg-light">
      <div className="relative isolate px-6 lg:px-8">
        ...
        <div className="flex items-center justify-center px-24">
          <div className="w-1/2 text-left max-w-5xl py-28">
            <h1 className="text-3xl font-bold sm:leading-normal text-dark dark:text-light sm:text-4xl">
              Perfecting the Art of Written Expression
            </h1>
            <p className="mt-6 text-base leading-7 text-gray-700 dark:text-gray-400">
              Experience the difference of a grammar checker that understands
          ...
          <div className="w-1/2">
            <img className="w-3/4 float-end" src={img1} alt="" />
          </div>
          <div
        ...
        <div id="Translator" className="py-24">
          <GrammarChecker />
        </div>
      </div>
    </div>
