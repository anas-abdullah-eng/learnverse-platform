...
const Footer = () => {
  ...
  return (
    <div className="overflow-hidden relative w-full bg-light dark:bg-slate-800 dark:text-light text-dark pt-40 py-2 px-2 ">
      <svg
      ...
      >
        <polygon
          points="0,1354.9 55.2,1376.5 100.4,1343 159.1,1359.7 336.6,1210.3 488.9,1343 586.1,1271 654.7,1294 840.5,1047.7 917.6,1139.4 954.4,1092.1 987.9,1139.4 1075,1059.1 1250.8,1171.2 1405,999.7 1405,1400 0,1400"
          fill={DarkMode ? "#7FC7D9" : "#365486"}
          opacity="0.1"
        >
          <animate
		...
		0,1354.9 55.2,1376.5 100.4,1343 159.1,1359.7 336.6,1210.3 488.9,1343 586.1,1271 654.7,1294 840.5,1047.7 917.6,1139.4 954.4,1092.1 987.9,1139.4 1075,1059.1 1250.8,1171.2 1405,999.7 1405,1400 0,1400"
            calcMode="spline"
            keySplines=".445 .05 .55 .95;.445 .05 .55 .95;.445 .05 .55 .95"
          />
        </polygon>
        <path
          fill={DarkMode ? "#DCF2F1" : "#365486"}
          opacity="0.5"
      ...
      <div className="max-w-[1240px] mx-auto grid grid-cols-2 md:grid-cols-6 border-b-2 border-dark dark:border-light py-8 z-10">
        ...
        <div className="col-span-2 pt-8 md:pt-2 text-center">
          <p className="font-bold uppercase ">
            English Expertise at Your Fingertips
          </p>
          <img className="w-48 my-5 mx-auto" src={logo} alt="LearnVers.png" />
        </div>
      </div>

      <div className="flex flex-col max-w-[1240px] px-2 py-4 mx-auto justify-between sm:flex-row text-center dark:text-light text-dark">
